import { Codec } from "../src/core";
import { Case } from "./codec.case";
import { assert } from "chai";

const cases0 = [
    new Case("BMP - 基本多文种平面", "Hello, World! - 你好，世界！ - Σ✨", [0x48, 0x65, 0x6C, 0x6C, 0x6F, 0x2C, 0x20, 0x57, 0x6F, 0x72, 0x6C, 0x64, 0x21, 0x20, 0x2D, 0x20, 0xE4, 0xBD, 0xA0, 0xE5, 0xA5, 0xBD, 0xEF, 0xBC, 0x8C, 0xE4, 0xB8, 0x96, 0xE7, 0x95, 0x8C, 0xEF, 0xBC, 0x81, 0x20, 0x2D, 0x20, 0xCE, 0xA3, 0xE2, 0x9C, 0xA8]),
...
const cases2 = [
    new Case("第 1 字节错误 : 越界", "", [0xF5]),
    new Case("第 1 字节错误 : 1 字节", "", [0x80]),
    new Case("第 2 字节丢失 : 2 字节", "", [0xC0]),
    new Case("第 2 字节丢失 : 3 字节", "", [0xE0]),
    new Case("第 2 字节丢失 : 4 字节", "", [0xF0]),
    new Case("第 2 字节错误 : 2 字节", "", [0xC0, 0x00]),
    new Case("第 2 字节错误 : 3 字节", "", [0xE0, 0x00, 0x80]),
    new Case("第 2 字节错误 : 4 字节", "", [0xF0, 0x00, 0x80, 0x80]),
    new Case("第 2 字节错误 : 越界", "", [0xF4, 0x90, 0x80, 0x80]),
    new Case("第 3 字节丢失 : 3 字节", "", [0xE0, 0x80]),
    new Case("第 3 字节丢失 : 4 字节", "", [0xF0, 0x80]),
    new Case("第 3 字节错误 : 3 字节", "", [0xE0, 0x80, 0x00]),
    new Case("第 3 字节错误 : 4 字节", "", [0xF0, 0x80, 0x00, 0x80]),
    new Case("第 4 字节丢失", "", [0xF0, 0x80, 0x80]),
    new Case("第 4 字节错误", "", [0xF0, 0x80, 0x80, 0x00]),
];
